// Package logger provides logging functionality with bazel-specific enhancements.
//
// Copied from https://github.com/aspect-build/aspect-cli/blob/main/pkg/logger/logger.go
package logger
